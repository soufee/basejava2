<%@ page import="ru.shoma.webapp.model.ContactType" %>
<%@ page import="ru.shoma.webapp.model.ListSection" %>
<%@ page import="ru.shoma.webapp.model.OrgSection" %>
<%@ page import="ru.shoma.webapp.model.SectionType" %>
<%@ page import="ru.shoma.webapp.util.DateUtil" %>
                    ...
                    <c:forEach var="org" items="<%=((OrgSection) section).getOrganizations()%>"
                        ...
                        <div style="margin-left: 30px">
                            <c:forEach var="pos" items="${org.positions}">
                                <jsp:useBean id="pos" type="ru.shoma.webapp.model.Organization.Position"/>
                                <dl>
